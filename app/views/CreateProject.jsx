...
const CreateProject = (props) => {
    const [projectNameInputValue, setProjectNameInputValue] = useState(props.error.length !== 0 ? props.message["name"] : '');
    const [projectAbstractInputValue, setProjectAbstractInputValue] = useState(props.error.length !== 0 ? props.message["abstract"] : '');
    const [authorsInputValue, setAuthorsInputValue] = useState(props.error.length !== 0 ? props.message["authors"] : '');
    const [tagInputValue, setTagInputValue] = useState(props.error.length !== 0 ? props.message["tags"] : '');
